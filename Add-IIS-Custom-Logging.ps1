...
Add-WebConfigurationProperty -pspath 'MACHINE/WEBROOT/APPHOST'  -filter "system.applicationHost/sites/site[@name='LabSite']/logFile/customFields" -name "." -value @{logFieldName='X-Client-Cert';sourceName='X-Client-Cert';sourceType='RequestHeader'}
